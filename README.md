...
| Bundle | Description | Tools | Extra |
|---|---|---|---|
| [curobo](tools/curobo/) | NVIDIA cuRobo motion planning — collision-free trajectories to grasp goalsets, constrained linear moves, single-pose planning, and joint-trajectory collision validation. | `curobo.plan_directed_linear`, `curobo.plan_grasp_motion`, `curobo.plan_linear`, `curobo.plan_to_grasp_poses`, `curobo.plan_to_pose`, `curobo.validate_joint_trajectory_grasped`, `curobo.validate_joint_trajectory_robot` | — |
